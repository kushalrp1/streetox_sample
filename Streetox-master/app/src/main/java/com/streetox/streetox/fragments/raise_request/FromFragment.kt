...
class FromFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentFromBinding.inflate(layoutInflater)
...
// Set the adjusted drawable to the start of the TextInputEditText
        ...
        requireActivity().onBackPressedDispatcher.addCallback(requireActivity(),object :OnBackPressedCallback(true){
            override fun handleOnBackPressed() {
                findNavController().navigate(R.id.action_fromFragment_to_searchFragment)
            }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchQueryViewModel.searchQuery.observe(viewLifecycleOwner) { query ->
            ...
            Log.d("locationissaving", query ?: "Query is null")

        }

        latLngViewModel.latitude.observe(viewLifecycleOwner){lat->
            latitude = lat
            Log.d("locationissaving", latitude.toString())

        }

        latLngViewModel.latitude.observe(viewLifecycleOwner){long ->
            longitude = long
            Log.d("locationissaving", longitude.toString())
        }
    }
    ...
    private fun on_search_click(){
        binding.search.apply {
            ...
            setOnClickListener {
                ...
                findNavController().navigate(R.id.action_fromFragment_to_locationSearchFragment)
            }
        }
    }
    ...
    private fun btn_go_click(){
        binding.btnGo.setOnClickListener {
            findNavController().navigate(R.id.action_fromFragment_to_toFragment)
        }
    }
